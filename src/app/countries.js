const countries = [
        ...
        { name: 'Congo, Democratic Republic of the', flag: 'cd.png' },
        { name: 'Congo, Republic of the', flag: 'cg.png' },
        ...
        { name: 'East Timor (Timor-Leste)', flag: 'tl.png' },
        ...
        { name: 'Korea, North', flag: 'kp.png' },
        { name: 'Korea, South', flag: 'kr.png' },
        { name: 'Kosovo', flag: 'xk.png' },
        { name: 'Kuwait', flag: 'kw.png' },
        { name: 'Kyrgyzstan', flag: 'kg.png' },
        { name: 'Laos', flag: 'la.png' },
        ...
        { name: 'Myanmar (Burma)', flag: 'mm.png' },
        ...
        { name: 'North Macedonia', flag: 'mk.png' },
        ...
        { name: 'Vatican City', flag: 'va.png' },
        { name: 'Venezuela', flag: 've.png' },
        { name: 'Vietnam', flag: 'vn.png' },
